...
/// MongoService (Langkah 5 - Smart Logging & Safe Reconnection)
///
/// Konsep : Service Layer pusat dengan Singleton Pattern.
/// Logika : _getSafeCollection() menjamin koleksi siap pakai (anti-crash).
///          Setiap metode CRUD memiliki level log yang dapat dikontrol di .env.
/// Tujuan : Transparansi aktivitas database tanpa mengotori terminal.
class MongoService {
  // ── Singleton ────────────────────────────────────────────────────────────
  ...
  // ── Guard: Auto-Reconnect jika Koneksi Terputus ─────────────────────────
  ...
  // ── Connect: Jabat Tangan dengan Atlas (Timeout 15 detik) ───────────────
  ...
  // ── READ: Mengambil data dari Cloud berdasarkan tim ─────────────────────
  ...
  // ── UPDATE: Mengganti seluruh dokumen berdasarkan ID ────────────────────
